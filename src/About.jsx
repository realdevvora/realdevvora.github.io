    ...
    return (
      <div className="text-center p-40 pt-20 text-blue-900 align-middle min-h-screen w-screen">
        ...
        <div className="flex">
            ...
            <img src="/about1.jpeg" alt="" className="max-w-64 max-h-64 border-4 border-blue-900 rounded-full ml-4" />
        </div>
  
        <h2 className="mt-4 text-5xl text-left font-bold">What Matters to Me?</h2>
        ...
        <div className="flex justify-between align-middle">
            <img src="/about2.jpeg" alt="" className="max-w-64 max-h-64 border-4 border-blue-900 rounded-full ml-4" />
            <li className="text-xl text-justify px-5">
            Firstly, <span className="font-bold hover:text-white duration-500">accountability</span>,
            ...
            <li className="text-xl text-justify px-5">
            Secondly, I prioritize <span className="font-bold hover:text-white duration-500">collaboration</span>. 
