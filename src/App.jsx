  ...
  return (
    <div className='app'>
      ...
      <div className="activities">
        <button id="about" className='activities-about section-button' onClick={modifyAbout}>About Me</button>
...
Secondly, I prioritize <strong>collaboration</strong>. I believe that teamwork tends to be underestimated in the field of development. However, the ability to leverage a skill set beyond mere code-writing is what brings value to a developer in the bigger picture.</div>
        <button id="initiatives" className='activities-initiatives section-button' onClick={modifyInitiatives}>Current Initiatives</button>
        ...
        {/* <img className="activities-initiatives activities-initiatives-timeline" src="timeline.jpeg" alt="" /> */}
        <div className="activities-initiatives activities-initiatives-text">
        ...
        <button id="projects" className='activities-projects section-button' onClick={modifyProjects}>Projects</button>
        <a className='activities-projects activities-projects-img' href="https://github.com/realdevvora/course-evaluations">
        ...
        <a className="activities-projects activities-projects-img" href="https://github.com/utmgdsc/TAIL-Trackr">
      ...
      <div className="logo-group">
        <a href="https://github.com/realdevvora">
          <img className="logo" id="github" src="github-logo.png" alt="" />
        </a>
        <a href="https://www.linkedin.com/in/devvora/">
          <img className="logo" id="linkedin" src="linkedin-logo.png" alt="" />
        </a>
      </div>
    </div>
  )
